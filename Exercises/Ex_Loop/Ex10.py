...
def main():
    ...
    arr_of_divisors = check_divisors_number(number)

    print(f"{Fore.MAGENTA} > {Fore.WHITE}Your number have {Fore.BLUE}{len(arr_of_divisors)}{Fore.WHITE} divisors")
    print(f"{Fore.MAGENTA} > {Fore.WHITE}The list of divisors: {Fore.BLUE}{arr_of_divisors}{Fore.WHITE}")
